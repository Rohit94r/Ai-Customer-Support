...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "chatbot for restaurant website",
    "chatbot for ecommerce website",
    "chatbot for coaching institute",
    "chatbot for clinic website",
    "chatbot for real estate",
    "chatbot for dentist website",
    "chatbot for hotel website",
    "chatbot for lawyer website",
    "chatbot for travel agency",
    "chatbot for education website",
    "chatbot for car dealership",
    "chatbot for wedding planner",
    "chatbot for salon website",
    "chatbot for gym website",
    "free live chat widget",
    "AI chatbot benefits small business",
  ],
